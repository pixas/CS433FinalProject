...
int main(int argc, char const *argv[]) {
    MALLOC_ERR_DECLARATION;
    cv::String model_name = "/home/group14/CS433FinalProject/task1/resnet18.onnx";
    ...
    DataLoader dt = DataLoader("/home/group14/CS433FinalProject/task1/select_file_list.txt", batch_size);
    ...
    std::ofstream file("predictions_opt.txt");
